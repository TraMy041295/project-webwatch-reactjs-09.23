...
function seeQuickOnApp(id){
  ...
  return (<>
    ...
    <div className='row top-discount'>
      <div className='col-md-3 col-12 col-sm-12 top-discount-item'>
      ...
      <div className='col-md-9 col-12 col-sm-12 top-discount-item item-watch row'>
        <div className='row'>
          {topDiscountItem.map(item =>
          <div className='col-md-3 col-6 col-sm-6 item-information'>
    ...
    <div className='introduce row'>
      <span className='col-md-1 col-1 col-sm-1 left'>“</span>
      <p className='col-md-10 col-10 col-sm-10'><i>Đồng hồ đeo tay là một trong những phát minh vĩ đại nhất trên thế giới. Trước đây đồng hồ đeo tay chủ yếu giúp
      ...
      <span className='col-md-1 col-1 col-sm-1 right'>”</span>
    </div>
    {/* ------------- customer */}
