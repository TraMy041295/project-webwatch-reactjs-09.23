...
function Nav(props) {
    ...
    return (<>
        ...
        <div className="menu row">
            <div className='menu-sticker col-md-1 col-1 col-sm-1 col-lg-2 col-xl-2 col-xxl-2'>
                ...
                <div id="mySidenav" className="sidenav row ">
                    <div className='sidenav-left col-md-4 col-12 col-sm-12 col-lg-4 col-xl-4 col-xxl-4'>
                       ...
                       <NavLink className='nav-link' to="/trang-chu" ><label className='label-trangchu' htmlFor='input-menu-sticker'>TRANG CHỦ</label></NavLink>
            ...
            {/* --------- cart */}
            <div className="cart row col-md-3 col-3 col-sm-3 col-lg-3 col-xl-3 col-xxl-3">
                ...
                <p className="cart-title row col-md-10 col-8 col-sm-10 col-lg-7 col-xl-6 col-xxl-5">
