...
function SeeQuickOnApp(props){
    ...
    <div className="seequickonapp-title row">
            <p className="col-md-8 col-8 ">{watchList[index].name}</p>
            <p className="col-md-2 col-2">{(watchList[index].gender == 1) ? <Link class="nav-link active" to="/men">Đồng hồ Nam</Link>  : <Link class="nav-link active" to="/women">Đồng hồ nữ</Link> } </p>
            <p className="col-md-2 col-2"><Link class="nav-link active" to="/trangchu"> Trang chủ</Link></p>
        </div>
        <div className="seequickonapp-content row">
            <div className="col-md-6 col-12 seequickonapp-content-left "><img  src={watchList[index].image}/> </div>
            <div className="col-md-6 col-12 seequickonapp-content-right">
